...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "QA_Peardoc_Coverage_Renderer_DeveloperListTest::main");
}
 ...
 */
class QA_Peardoc_Coverage_Renderer_DeveloperListTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("QA_Peardoc_Coverage_Renderer_DeveloperListTest");
...
// Call QA_Peardoc_Coverage_Renderer_DeveloperListTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "QA_Peardoc_Coverage_Renderer_DeveloperListTest::main") {
