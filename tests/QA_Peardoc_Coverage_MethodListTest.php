...
if (!defined("PHPUnit2_MAIN_METHOD")) {
    define("PHPUnit2_MAIN_METHOD", "QA_Peardoc_Coverage_MethodListTest::main");
}
 ...
 */
class QA_Peardoc_Coverage_MethodListTest extends PHPUnit2_Framework_TestCase {
    /**
    ...
    public static function main() {
        ...
        $suite  = new PHPUnit2_Framework_TestSuite("QA_Peardoc_Coverage_MethodListTest");
...
// Call QA_Peardoc_Coverage_MethodListTest::main() if this source file is executed directly.
if (PHPUnit2_MAIN_METHOD == "QA_Peardoc_Coverage_MethodListTest::main") {
